...
<html>
<head>
    <title>Despo Couture - Gestion des clients</title>
    ...
    <div class="container p-4">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <th scope="col">Prise de rendez-vous</th>
            </tr>
            </thead>
            <tbody>
            <?php
                ...
                foreach ($clients as $client) {
                    echo "<tr>";
                    echo "<td>" . $client['IdClit'] . "</td>";
                    echo "<td>" . $client['NomClit'] . "</td>";
                    echo "<td>" . $client['PrenClit'] . "</td>";
                    if($client['SexeClit'] == 'M')
                        echo "<td>Homme</td>";
                    else
                        echo "<td>Femme</td>";
                    echo "<td>" . $client['EmailClit'] . "</td>";
                    echo "<td>" . $client['ContClit'] . "</td>";
                    echo "<td>" . $client['AdressClit'] . "</td>";
                    echo "<td><a href='formEditClient.php?id=" . $client['IdClit'] . "' class='btn btn-warning'>Modifier</a></td>";
                    echo "<td><a href='formDeleteClient.php?id=" . $client['IdClit'] . "' class='btn btn-danger'>Supprimer</a></td>";
                    echo "<td><a href='formCreateRdv.php?client=" . $client['IdClit'] . "' class='btn btn-success'>Prendre rendez-vous</a></td>";
                    echo "</tr>";
                }
            ?>
            </tbody>
        </table>
        <a href="formCreateClient.php" class="btn btn-success">Créer un client</a>
    </div>

...
<html>
<head>
    <title>Despo Couture - Gestion des comptes</title>
        ...
        <table class="table">
            ...
            <tbody>
                <?php
                    ...
                    if($comptes == null)
                    {
                        echo "<tr><td colspan='7'>Aucun compte trouvé</td></tr>";
                        exit();
                    }

                    foreach($comptes as $compte)
                    {
                        $employe = getEmployeById($compte["IdEmp"]);

                        echo "<tr>";
                        echo "<td>" . $compte["IdCompte"] . "</td>";
                        echo "<td>" . $compte["NomUtilCompte"] . "</td>";
                        echo "<td>" . $employe["NomEmp"] . " " . $employe["PrenEmp"] . "</td>";
                        echo "<td>" . $compte["DateCreaCompte"] . "</td>";
                        echo "<td>" . $compte["RoleCompte"] . "</td>";
                        echo "<td><a href='formEditCompte.php?id=" . $compte["IdCompte"] . "' class='btn btn-warning'>Modifier</a></td>";
                        echo "<td><a href='formDeleteCompte.php?id=" . $compte["IdCompte"] . "' class='btn btn-danger'>Supprimer</a></td>";
                        echo "</tr>";
                    }
                ?>
            </tbody>
        </table>
        <a href="formCreationCompte.php" class="btn btn-success">Créer un compte</a>
    </div>

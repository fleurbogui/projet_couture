...
<html>
<head>
    <title>Despo Couture - Gestion des rendez-vous</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container p-4">
            ...
            <tbody>
                <?php
                    ...
                    else
                    {
                        foreach($rdvs as $rdv)
                        {
                            $client = getClientById($rdv["IdClit"]);
                            $employe = getEmployeById($rdv["IdEmp"]);
                            echo "<tr>";
                            echo "<td>".$rdv["IdRdv"]."</td>";
                            echo "<td>".$rdv["LibRdv"]."</td>";
                            echo "<td>".$rdv["DateHeureRdv"]."</td>";
                            echo "<td>".$client["NomClit"]." ".$client["PrenClit"]."</td>";
                            echo "<td>".$employe["NomEmp"]." ".$employe["PrenEmp"]."</td>";
                            echo "<td><a href='formEditRendezvous.php?id=".$rdv["IdRdv"]."' class='btn btn-warning'>Modifier</a></td>";
                            echo "<td><a href='formDeleteRendezvous.php?id=".$rdv["IdRdv"]."' class='btn btn-danger'>Supprimer</a></td>";
                            echo "</tr>";
                        }
                    }
                ?>
        ...
        <a href='formCreateRdv.php' class='btn btn-success'>Créer un rendez-vous</a>
    </div>

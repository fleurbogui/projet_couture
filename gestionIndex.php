...
<html>
<head>
    <title>Despo Couture - Accueil Gestion</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container p-4">
        <?php
            ...
            showMessage();
        ?>
        <h2>Bienvenue sur le panel de gestion</h2>
        <p>Utilisez le menu pour naviguer vers les différentes sections de gestion.</p>
    </div>
